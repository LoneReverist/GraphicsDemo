...
void Renderer::Render() const
{
	...
	for (std::weak_ptr<RenderObject> render_object : m_render_objects)
	{
		...
		shader_program.SetUniform("pointlight_radius_1", m_pointlight_1.radius);
		shader_program.SetUniform("pointlight_pos_2", m_pointlight_2.pos);
		shader_program.SetUniform("pointlight_color_2", m_pointlight_2.color);
		shader_program.SetUniform("pointlight_radius_2", m_pointlight_2.radius);
		shader_program.SetUniform("pointlight_pos_3", m_pointlight_3.pos);
		shader_program.SetUniform("pointlight_color_3", m_pointlight_3.color);
		shader_program.SetUniform("pointlight_radius_3", m_pointlight_3.radius);
		shader_program.SetUniform("spotlight_pos", m_spotlight.pos);
		shader_program.SetUniform("spotlight_dir", m_spotlight.dir);
